...
import {faHome, faUserMinus, faUserPlus} from "@fortawesome/free-solid-svg-icons";
...
function Add() {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            await axios.post('api/sendMail/remove', form);
            alert('Message sent!');
            setForm({ name: '', tag: '' });
        } catch (error) {
        ...
        <Form className={"contactForm"} >
            <div className={"addButton"}>
                ...
                <div
                    ...
                    tabIndex="0"
                >
                    <FontAwesomeIcon icon={faUserMinus} className={"backIcon"}/>
                    Remove
                </div>
